...
def apply_professional_theme(window):
    ...
    # Основные цвета
    palette.setColor(QPalette.Window, QColor(COLORS_V2['bg_main']))
    palette.setColor(QPalette.WindowText, QColor(COLORS_V2['text_primary']))
    palette.setColor(QPalette.Base, QColor(COLORS_V2['bg_input']))
    palette.setColor(QPalette.AlternateBase, QColor(COLORS_V2['grid_alternate']))
    palette.setColor(QPalette.ToolTipBase, QColor(COLORS_V2['bg_card']))
    palette.setColor(QPalette.ToolTipText, QColor(COLORS_V2['text_primary']))
    palette.setColor(QPalette.Text, QColor(COLORS_V2['text_primary']))
    palette.setColor(QPalette.Button, QColor(COLORS_V2['bg_card']))
    palette.setColor(QPalette.ButtonText, QColor(COLORS_V2['text_primary']))
    palette.setColor(QPalette.BrightText, QColor(COLORS_V2['danger']))
    palette.setColor(QPalette.Link, QColor(COLORS_V2['accent_primary']))
    palette.setColor(QPalette.LinkVisited, QColor(COLORS_V2['accent_secondary']))
    palette.setColor(QPalette.Highlight, QColor(COLORS_V2['accent_primary']))
    palette.setColor(QPalette.HighlightedText, QColor(COLORS_V2['text_primary']))
    palette.setColor(QPalette.PlaceholderText, QColor(COLORS_V2['text_tertiary']))
    
    # Отключенный текст
    palette.setColor(QPalette.Disabled, QPalette.Text, QColor(COLORS_V2['text_disabled']))
    palette.setColor(QPalette.Disabled, QPalette.ButtonText, QColor(COLORS_V2['text_disabled']))
    palette.setColor(QPalette.Disabled, QPalette.WindowText, QColor(COLORS_V2['text_disabled']))
