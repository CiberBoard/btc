...
from PyQt6.QtCore import Qt, QRegularExpression, QSize, QTimer, QRegularExpressionValidator
from PyQt6.QtGui import QFont, QRegularExpressionValidator, QColor, QIcon
...
class MainWindowUI_V2:
    ...
    def _add_gpu_target_section(self, layout):
        ...
        self.parent.gpu_start_key_edit.setValidator(
            QRegularExpressionValidator(QRegularExpression("[0-9a-fA-F]+"), self.parent)
        )
    ...
    def _add_gpu_control_section(self, layout):
        ...
        self.parent.gpu_start_stop_btn.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
